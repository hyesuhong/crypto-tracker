    ...
    <Container>
      ...
      {loading ? (
        ...
        <>
          <InfoList>
            <InfoSummary>
              <p><span>Rank</span><br />{info?.rank}</p>
              <p><span>Symbol</span><br />{info?.symbol}</p>
              <p><span>Open Source</span><br />{info?.open_source ? 'Yes' : 'No'}</p>
            </InfoSummary>
            <InfoDesc>{info?.description}</InfoDesc>
          </InfoList>
          <InfoList>
            <InfoSummary>
              <p><span>Total Supply</span><br />{priceInfo?.total_supply}</p>
              <p><span>Max Supply</span><br />{priceInfo?.max_supply}</p>
            </InfoSummary>
          </InfoList>
